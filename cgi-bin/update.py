...
mime_types = { ".txt":"text/plain", ".css":"text/plain", ".html":"text/html", ".jpg" : "image/jpeg", ".png" : "image/png", ".mpeg" : "audio/mpeg", ".ogg" : "audio/ogg", ".mp4" : "video/mp4", ".json" : "application/json", ".js" : "application/javascript" }
...
for filename in os.listdir():
    ...
    if (filename[0] == '.' or mime == '.' or filename == 'cgi-bin'):
        pass
    else:
